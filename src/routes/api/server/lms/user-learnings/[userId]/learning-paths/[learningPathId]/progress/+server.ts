...
import { getLearningPathProgress } from '$routes/api/services/lms/user-learnings';
...
export const GET = async (event: RequestEvent) => {
	try {
		...
		const response = await getLearningPathProgress(sessionId, userId, learningPathId);
