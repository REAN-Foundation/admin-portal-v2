...
<div class="flex flex-wrap justify-end gap-2 px-6 py-2">
	<button
				...
				<table class="health-system-table">
					...
					<tbody>
						...
						<!-- <tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isPersonalizationEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isPersonalizationEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Personalization</span>
								</div>
							</td>
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isLocalizationEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isLocalizationEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Localization</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isLocationContextEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isLocationContextEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Location Context</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isRemindersMedicationEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isRemindersMedicationEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Reminders Medication</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isRemindersAppointmentEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isRemindersAppointmentEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Reminders Appointment</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isQnAEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isQnAEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isConsentEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isConsentEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Consent</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isWelcomeMessageEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isWelcomeMessageEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Welcome Message</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isFeedbackEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isFeedbackEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isAppointmentFollowupEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isAppointmentFollowupEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Appointment Followup</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isConversationHistoryEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isConversationHistoryEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Conversation History</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
						...
						<tr>
							<td>
								<div class="flex flex-1 items-center gap-2">
									{#if edit === true && isEmojisEnabled}
										<span class="text-green-500">✅</span>
									{:else if edit === true && !isEmojisEnabled}
										<span>❌</span>
									{:else}
										<input type="checkbox" class="checkbox checkbox-primary" disabled={edit} />
										<Icons
										...
										/>
									{/if}
									<span class="text-base">Emojis</span>
								</div>
							</td>
							<td class="flex justify-end">
								<InfoIcon
