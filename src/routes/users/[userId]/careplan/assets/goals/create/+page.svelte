<script lang="ts">
	...
	import type { GoalsCreateModel } from '$lib/types/goals.js';
	import { createOrUpdateSchema } from '$lib/validation/goals.schema.js';
	...
	const handleSubmit = async (event: Event) => {
		try {
			...
			const goalsCreateModel: GoalsCreateModel = {
				Name: name,
			...
			console.log(goalsCreateModel);
			const res = await fetch(`/api/server/careplan/assets/goals`, {
				method: 'POST',
				body: JSON.stringify(goalsCreateModel),
