...
<div class=" basic-container">
    <div class="overflow-x-auto">
        <table class="min-w-full border">
            <tbody>
                <tr class="border">
                    <td class=" row-content w-[10%] sm:pl-3">Tenant Name</td>
                    <td class=" row-content w-[10%]">American Heart Association</td>
                    <td class=" row-content w-[15%]">Name of the tenant/organization.</td>
                </tr>
                <tr class="border">
                    <td class=" row-content w-[10%] sm:pl-3">Start Date</td>
                    <td class=" row-content w-[10%]">{formatDate(data.basicStatistics.StartDate)}</td>
                    <td class=" row-content w-[15%]">Start date of the analysis period.</td>
                </tr>
                <tr class="border">
                    <td class=" row-content w-[10%] sm:pl-3">End Date</td>
                    <td class=" row-content w-[10%]">{formatDate(data.basicStatistics.EndDate)}</td>
                    <td class=" row-content w-[10%]">End date of the analysis period.</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="mt-4 overflow-x-auto">
        <table class="min-w-full border">
            <tbody>
                <tr class="border">
                    <td class=" row-content w-[10%] sm:pl-3">Total Users</td>
                    <td class=" row-content w-[10%]">{data.basicStatistics.TotalUsers}</td>
                    <td class=" row-content w-[15%]">Overall count of users associated with the tenant.</td>
                </tr>
                <tr class="border">
                    <td class=" row-content w-[10%] sm:pl-3">Total Patients</td>
                    <td class=" row-content w-[10%]">{data.basicStatistics.TotalPatients}</td>
                    <td class=" row-content w-[15%]"
                        >Total number of patients registered within the system.</td
                    >
                </tr>
                <tr class="border">
                    <td class=" row-content w-[10%] sm:pl-3">Total Active Patients</td>
                    <td class=" row-content w-[10%]">{data.basicStatistics.TotalActivePatients}</td>
                    <td class=" row-content w-[15%]">Total number of active (Not-deleted) patients.</td>
                </tr>
            </tbody>
        </table>
    </div>
</div>
<div class="text grid-layout history-container">
...
<div class=" patient-history-container">
    ...
    <div class="centered-flex user-roles-container">
