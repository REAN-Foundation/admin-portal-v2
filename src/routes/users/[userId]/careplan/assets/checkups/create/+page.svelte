<script lang="ts">
	...
	import type { CheckupsCreateModel } from '$lib/types/checkups.types.js';
	import { createOrUpdateSchema } from '$lib/validation/checkups.schema.js';
	...
	// Get asset type from URL params or default to 'Checkup'
	...
	const handleSubmit = async (event: Event) => {
		try {
			...
			console.log(checkupsCreateModel);
			const res = await fetch(`/api/server/careplan/assets/checkups`, {
				method: 'POST',
				body: JSON.stringify(checkupsCreateModel),
...
<div class="p-6">
	<form onsubmit={async (event) => (promise = handleSubmit(event))}>
		<div class="form-headers">
			<h2 class="form-titles">Create Checkup</h2>
