<script lang="ts">
	...
	import type { NutritionCreateModel } from '$lib/types/nutrition.types.js';
	import { createOrUpdateSchema } from '$lib/validation/nutrition.schema.js';
	...
	// Get asset type from URL params or default to 'Nutrition'
	...
	const handleSubmit = async (event: Event) => {
		try {
			...
			const nutritionCreateModel: NutritionCreateModel = {
				Name: name,
			...
			const res = await fetch(`/api/server/careplan/assets/nutrition`, {
				method: 'POST',
				body: JSON.stringify(nutritionCreateModel),
...
<div class="p-6">
	<form onsubmit={async (event) => (promise = handleSubmit(event))}>
		<div class="form-headers">
			<h2 class="form-titles">Create Nutrition</h2>
