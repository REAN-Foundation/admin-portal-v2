import { BACKEND_API_URL, API_CLIENT_INTERNAL_KEY, CAREPLAN_BACKEND_API_URL } from '$env/static/private';
import { DashboardManager } from '$routes/api/cache/dashboard/dashboard.manager';
import { del, get, post, put } from '../../services/reancare/common.reancare';
import type { CareplanCategoryCreateModel, CareplanCategoryUpdateModel } from '$lib/types/careplan.category.types';
////////////////////////////////////////////////////////////////
...
export const searchCareplanCategories = async (sessionId: string, searchParams?) => {
    ...
    console.log("careplan-categories url",url)
