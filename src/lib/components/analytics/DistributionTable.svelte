...
{#if hasData}
	<div class=" stats-container grid-cols-2 md:grid-cols-3 border sm:px-4">
		<div class="col-span-2 items-center justify-center px-4 sm:px-6 lg:px-8">
			<div class="flow-root">
							...
							<thead>
								<tr class=" w-[100%]">
									{#each tableHeaders as header}
										<th
											class="w-[30%] border py-3 pr-3 pl-4 text-left text-sm font-semibold sm:pl-3"
										>
											{header}
										</th>
									{/each}
...
{:else}
	<div class="stats-container border p-4 shadow-xl sm:px-4">
		<p
			class="flex place-content-center place-items-center items-center justify-center text-center text-lg font-semibold"
		>
			Data Not Available
		</p>
	</div>
