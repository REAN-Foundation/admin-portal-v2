...
<div class="mx-auto w-full px-6 py-4">
	...
	<div class="forms-container">
		<div class="form-header">
			<h2 class="form-title">View Exercise</h2>
		...
		<table class="form-table">
			<tbody>
				...
				<tr>
					<td class="form-td-left">Exercise Type</td>
					<td class="form-td-right">{exerciseType}</td>
				</tr>
				<tr>
					<td class="form-td-left">Intensity Level</td>
					<td class="form-td-right">{intensityLevel}</td>
				</tr>
				<tr>
