...
import type { ProfileUpdateModel } from '$lib/types/profile.types';
import { createOrUpdateSchema } from '$lib/validation/profile.schema';
...
export const PUT = async (event: RequestEvent) => {
    try {
        ...
        const data: ProfileUpdateModel = await request.json();
