<script lang="ts">
	...
	import type { WebNewsfeedsCreateModel } from '$lib/types/web.newsfeeds.js';
	import { createOrUpdateSchema } from '$lib/validation/web.newsfeeds.schema.js';
	...
	const handleSubmit = async (event: Event) => {
		try {
			...
			const webNewsfeedsCreateModels: WebNewsfeedsCreateModel = {
				Name: name,
			...
			const res = await fetch(`/api/server/careplan/assets/web-newsfeeds`, {
				method: 'POST',
				body: JSON.stringify(webNewsfeedsCreateModels),
...
<div class="p-6">
	<form onsubmit={async (event) => (promise = handleSubmit(event))}>
		<div class="form-headers">
			<h2 class="form-titles">Create Web Newsfeed</h2>
