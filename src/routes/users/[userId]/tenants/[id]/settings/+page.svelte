								...
								<div class=" border-hover rounded-xl border p-4 text-gray-700">
									<div class="flex items-center justify-between gap-3">
										...
										<div class="flex flex-grow flex-col">
											...
											<p class="text-sm">short description for Chatbot.</p>
										</div>
								...
								<div class=" border-hover rounded-xl border p-4 text-gray-700">
									<div class="flex items-center justify-between gap-3">
										...
										<div class="flex flex-grow flex-col">
											...
											<p class="text-sm">short description for Followup.</p>
										</div>
										<!-- Right: Toggle + Optional Edit -->
										<div class="flex items-center">
											<input
								...
								<div class=" border-hover rounded-xl border p-4 text-gray-700">
									<div class="flex items-center justify-between gap-3">
										...
										<div class="flex flex-grow flex-col">
											...
											<p class="text-sm">short description for Forms.</p>
										</div>
										<!-- Right: Toggle + Optional Edit -->
										<div class="flex items-center">
											<input
								...
								<div class=" border-hover rounded-xl border p-4 text-gray-700">
									<div class="flex items-center justify-between gap-3">
										...
										<div class="flex flex-grow flex-col">
											...
											<p class="text-sm">short description for PatientApp.</p>
										</div>
										<!-- Right: Toggle + Optional Edit -->
										<div class="flex items-center">
											<input
								...
								<div class=" border-hover rounded-xl border p-4 text-gray-700">
									<div class="flex items-center justify-between gap-3">
										...
										<div class="flex flex-grow flex-col">
											...
											<p class="text-sm">short description for PatientPortal.</p>
										</div>
										<!-- Right: Toggle + Optional Edit -->
										<div class="flex items-center">
											<input
