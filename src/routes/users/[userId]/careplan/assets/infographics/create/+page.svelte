<script lang="ts">
	...
	import type { InfographicsCreateModel } from '$lib/types/infographics.types.js';
	import { createOrUpdateSchema } from '$lib/validation/infographics.schema.js';
	...
	const handleSubmit = async (event: Event) => {
		try {
			...
			const infographicsCreateModel: InfographicsCreateModel = {
				Name: name,
			...
			console.log(infographicsCreateModel);
			const res = await fetch(`/api/server/careplan/assets/infographics`, {
				method: 'POST',
				body: JSON.stringify(infographicsCreateModel),
...
<div class="p-6">
	<form onsubmit={async (event) => (promise = handleSubmit(event))}>
		<div class="form-headers">
			<Heading text="Create Infographic" />
